...
> ```
> Note: I typically only sync the `.agents/plugins/marketplace.json` file and skip any upstream changes to `.claude-plugin/` to avoid clobbering my local plugins.
